...
public class BucketSorter : IIntegerSorter
{
    ...
    public void Sort(int[] array)
    {
        ...
        for (var pass = 1; pass <= totalDigits; pass++)
        {
            ...
            if (pass != totalDigits) EmptyBucket(buckets); // set size of buckets to 0
        }
    }
    ...
    {
        return (int) Math.Floor(Math.Log10(array.Max()) + 1);
    }
    ...
    {
        for (var i = 0; i < NumOfDigitsInBase10; i++) buckets[i, 0] = 0; // set size of bucket to 0
    }
