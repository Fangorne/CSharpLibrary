...
/// <summary>
///     <para>
///         Levenshtein distance between two words is the minimum number of single-character edits (insertions, deletions
...
public static class LevenshteinDistance
{
    ...
    public static int Calculate(string source, string target)
    {
        ...
        for (var i = 0; i <= target.Length; i++) distances[0, i] = i;
