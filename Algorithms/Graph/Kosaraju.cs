...
public static class Kosaraju<T>
{
    ...
    public static void Visit(Vertex<T> v, IDirectedWeightedGraph<T> graph, HashSet<Vertex<T>> visited,
        Stack<Vertex<T>> reversed)
    {
        ...
        // Visit neighbors
        foreach (var u in graph.GetNeighbors(v)) Visit(u!, graph, visited, reversed);
    }
    ...
    public static Dictionary<Vertex<T>, Vertex<T>> GetRepresentatives(IDirectedWeightedGraph<T> graph)
    {
        ...
        var reversedL = new Stack<Vertex<T>>();
        var representatives = new Dictionary<Vertex<T>, Vertex<T>>();
    ...
    public static IEnumerable<Vertex<T>>[] GetScc(IDirectedWeightedGraph<T> graph)
    {
        ...
        var scc = new Dictionary<Vertex<T>, List<Vertex<T>>>();
