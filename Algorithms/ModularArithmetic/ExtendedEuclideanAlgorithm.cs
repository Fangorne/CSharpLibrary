...
public static class ExtendedEuclideanAlgorithm
{
    ...
    /// <returns>
    ///     A record of ExtendedEuclideanAlgorithmResult containing the bezout coefficients of a and b as well as the
    ///     gcd(a,b).
    /// </returns>
    public static ExtendedEuclideanAlgorithmResult<long> Compute(long a, long b)
    {
        ...
        if (b != 0) bezoutOfB = (gcd - bezoutOfA * a) / b; // integer division
