...
public class HyperLogLog<T> where T : notnull
{
    ...
    public void Add(T item)
    {
        ...
        var j = Convert.ToInt32(binString.Substring(0, Math.Min(P, binString.Length)),
            2); // convert first b bits to register index
    ...
    public int Cardinality()
    {
        ...
        var z = setRegisters.Sum(index => Math.Pow(2, -1 * registers[index]));
